...
export default function ApplyLoanDetails({
  setCurrentStep
}: {
  ...
  useEffect(() => {
    if (user) {
      ...
      if (loans.length > 0) {
        ...
        setSelectedBank({
          id: loans[0].lending_bank_id?.toString() || '',
          name: loans[0].bank_name || '',
          description: 'Public sector banking',
          logo: '🏦',
          interest_min: loans[0].interest_rate_min || 0,
          interest_max: loans[0].interest_rate_max || 0
        });
  ...
  const saveLoanState = () => {
    ...
    try {
      const requestData = {
        ...
        duration: 24.0,
        lending_bank_id: selectedBank?.id
          ? parseInt(selectedBank.id)
          : undefined,
  ...
  const validateForm = (): boolean => {
    let valid =
      selectedFinancingType.length > 0 &&
  ...
  return (
    <div className='max-w-6xl space-y-8 p-6'>
      <div className='space-y-2'>
        <h1 className='text-foreground text-2xl font-bold'>Loan details</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <p className='text-muted-foreground'>
            Choose the type of business financing you need
          </p>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <p className='text-muted-foreground'>
            Choose a country to see available lenders
          </p>
        </CardHeader>
        <CardContent>
          ...
          {selectedCountry && (
            <Card className='mt-8'>
              <CardHeader>
                ...
                <p className='text-muted-foreground'>
                  Select your preferred lender for the loan application from{' '}
                  {selectedCountry}
                </p>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        <div className='flex items-center space-x-3'>
                          ...
                          <div className='flex-1'>
                            ...
                            <p className='text-muted-foreground mt-1 text-sm'>
                              Interest range: {bank.interest_min}% -{' '}
                              {bank.interest_max}%
                            </p>
                          </div>
                          {selectedBank?.name === bank.name && (
