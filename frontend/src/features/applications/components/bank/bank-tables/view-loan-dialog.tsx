      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            {activeView === 'details'
              ...
              : activeView === 'insights' ? 'Review the insights categories that will be generated by encrypted data computation' : `${steps[currentStep].description}`}
          </DialogDescription>
        </DialogHeader>
        ...
        {loan &&
          (activeView === 'details' ? (
            ...
            </div>) : (<div>{currentStep === 0 ? <InsightsRequest /> : currentStep === 1 ? <DataShare /> : <InsightsSend />}</div>)
          )}
        {!(activeView === "scene") &&
