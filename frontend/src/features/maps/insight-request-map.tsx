...
function InsightRequestMap({ chartID }: { chartID: string }) {
  ...
  const initMap = (): { polygons: any; points: any; chart: any } => {
    ...
    //   );
      ...
      lineDataItem.set('pointsToConnect', [singapore, india]);
...
export default InsightRequestMap;
