...
function DataShareMap({ chartID }: { chartID: string }) {
    ...
    const initMap = (): { polygons: any, points: any, chart: any } => {
        if (rootRef.current) {
            ...
            let cities = [
                {
                    title: "LoanConnect",
                    id: "loanConnect",
                    geometry: { type: "Point", coordinates: [79.1025, 22.740] },
                },
                {
                    title: "Credit Bureaus",
                    id: "credit",
                    geometry: { type: "Point", coordinates: [31.8206, 25.2504] }
                },
                {
                    title: "Tax Authorities",
                    id: "tax",
                    geometry: { type: "Point", coordinates: [36.8777, 1.0760] }
                },
                {
                    title: "SME Mock Bank",
                    id: "bank",
                    geometry: { type: "Point", coordinates: [22.9375, -30.567] }
                }
            ]
            ...
            let destinations = ["credit", "tax", "bank"];

            // London coordinates
            let originLongitude = 79.1025;
            let originLatitude = 22.740;
            ...
            am5.array.each(destinations, function (did) {
                ...
                lineDataItem.set("pointsToConnect", [destinationDataItem, londonDataItem])
