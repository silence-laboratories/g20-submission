...
import CreditShareMap from './credit-share-map';
...
export default function CreditShare() {
  return (
    <div className='flex gap-4'>
      <ProgressStepsCard steps={progressSteps} currentStep={4} />
      <div className='flex-1'>
        <CreditShareMap chartID='credit-share-map' />
      </div>
    </div>
  );
}
