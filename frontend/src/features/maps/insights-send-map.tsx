...
function InsightSendMap({ chartID }: { chartID: string }) {
  ...
  const initMap = (): { polygons: any; points: any; chart: any } => {
    ...
    //   );
      ...
      lineDataItem.set('pointsToConnect', [india, singapore]);
