...
import FinanceShareMap from './finance-share-map';
...
export default function FinanceShare() {
  return (
    <div className='flex gap-4'>
      <ProgressStepsCard steps={progressSteps} currentStep={2} />
      <div className='flex-1'>
        <FinanceShareMap chartID='finance-share-map' />
      </div>
    </div>
  );
}
